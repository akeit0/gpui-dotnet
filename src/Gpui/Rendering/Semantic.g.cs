...
namespace Gpui.Interop
{
    ...
    internal enum OpCode : ushort
    {
        ...
        ListOnTooltipRequested = 380,
        RowTooltipTarget = 382,
        ImageObjectFit = 400,
        ImageGrayscale = 401,
        InputDisabled = 500,
        InputReadOnly = 501,
    ...
    internal static class SemanticRegistry
    {
        ...
        private static ulong Capabilities(ComponentId component) => component switch
        {
            ...
            ComponentId.Table => 0x0000000040010143UL,
        ...
        private static ulong RequiredCapability(OpCode operation) => operation switch
        {
            ...
            OpCode.ListOnTooltipRequested => 0x0000000000000100UL,
            OpCode.RowTooltipTarget => 0x0000000000000001UL,
            ...
            OpCode.TooltipRowAnchor => 0x0000000000001000UL,
