        ...
        return ui.VStack(
                ...
                ui.HStack(
                        ...
                        ui.Button(
                                "toggle-tab-stop",
                                _tabStop
                                    ? "Skip preview in Tab order"
                                    : "Include preview in Tab order"
                            )
                            .OnClick(
                                this,
                                static (view, _) =>
                                {
                                    view._tabStop = !view._tabStop;
                                    view.Invalidate();
                                }
                            )
                            .Style(SampleStyles.Button(theme))
                ...
                ui.Input(
                        ref _notes,
                        new InputOptions(
                            placeholder: "Arrow keys edit here; the preview stays unchanged."
                        )
                    )
                    .Width(Percent(100)),
                ui.Text(
            ...
            .OnShortcut(
                this,
                new(ShortcutKey.D1, ShortcutModifiers.Primary),
                static view => view._preview.Focus()
            );
    }
}
